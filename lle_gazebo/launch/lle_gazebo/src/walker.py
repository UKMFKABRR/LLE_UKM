...
class WFunc:
    """
    Multi-joint walk function for lle
    """
    def __init__(self,**kwargs):
        self.parameters={}

        
        self.parameters["step_scale"]=0.5
        self.parameters["step_offset"]=0.0
        self.parameters["ankle_offset"]=0
        self.parameters["vx_scale"]=0.02
        self.parameters["vt_scale"]=0
    ...
    def generate_right(self):
        ...
        for j in l:
            self.pfn[j+"_r"]=self.afn[j+"_l"]
            self.afn[j+"_r"]=self.pfn[j+"_l"]
...
class Walker:
    ...
    def __init__(self,lle):
        ...
        self._sub_cmd_vel=rospy.Subscriber(lle.ns+"cmd_vel",Twist,self._cb_cmd_vel,queue_size=1)
    ...
    def init_walk(self):
        ...
        if self.get_dist_to_ready()>0.02:                    
            self.lle.set_angles_slow(self.ready_pos)        
...
if __name__=="__main__":
    ...
    rospy.loginfo("Instantiating lle Client")
    lle=LLE()
    rospy.loginfo("Instantiating lle Walker")
    walker=Walker(lle)
 
    rospy.loginfo("lle Walker Ready")
